				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input type="text" id="name" name="nam" placeholder="Họ tên" required>
						</div>
						<div class="form-block">
						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									@foreach($spmua as $sp)
										<div class="media">
											<img width="25%" src="source/images/product/{{$sp['item']['image']}}" alt="" class="pull-left">
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">{{$thanhtien}}</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
