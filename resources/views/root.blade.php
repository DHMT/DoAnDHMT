					...
					<div class="beta-comp">
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-item">
									<div class="media">
										<a class="pull-left" href="#"><img src="source/images/product/{{$sp['item']['image']}}" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">{{$sp['item']['name']}}</span>
											
											<span class="cart-item-amount">{{$sp['qty']}}*<span>@if($sp['item']['promotion_price'] ==0){{$sp['item']['unit_price']}}@else{{$sp['item']['promotion_price']}}@endif</span></span>
										</div>
									</div>
								</div>
								<a href="{{route('xoa',$sp['item']['id'])}}">X</a>
								@endforeach
								

								<div class="cart-caption">
									<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{$thanhtien}}</span></div>
									<div class="clearfix"></div>
